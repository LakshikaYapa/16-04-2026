<template>
  <section class="bg-black text-white flex flex-col md:flex-row items-center p-10">
...
<div class="bg-black text-white min-h-screen flex items-center">
  ...
  into extraordinary dishes that bring joy to every table.
      ...
      <p class="text-lg text-gray-400 mb-6">
        Learn to cook like a professional chef with our carefully curated collection of delicious meals. 
